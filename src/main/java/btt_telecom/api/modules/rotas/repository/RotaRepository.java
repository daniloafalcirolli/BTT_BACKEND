package btt_telecom.api.modules.rotas.repository;
...
public interface RotaRepository extends JpaRepository<Rota, Long>{
	...
	@Query(value = "SELECT * FROM ROTAS r WHERE r.DESCRICAO = 'almoço' AND r.DATA = to_date(?1, 'yyyy-mm-dd') AND CPF_FUNCIONARIO = ?2", nativeQuery = true)
	List<Rota> findAlmocoByFuncionario(String data, String cpf_funcionario);
}
